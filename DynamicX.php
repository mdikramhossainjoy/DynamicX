 ...
 * Plugin URI: https://github.com/mdikramhossainjoy/DynamicX
 * Documentation: https://mdikramhossainjoy.com/docs/DynamicX
 * GitHub: https://github.com/mdikramhossainjoy/DynamicX
...
class DynamicX {
    ...
    public function add_custom_fields_metabox() {
        add_meta_box('DynamicX_custom_fields', 'Custom Fields', [$this, 'custom_fields_callback'], 'product', 'normal', 'high');
    }

    public function custom_fields_callback($post) {
        $custom_fields = get_post_meta($post->ID, '_DynamicX_custom_fields', true);
    ...
    public function save_custom_fields($post_id) {
        ...
        update_post_meta($post_id, '_DynamicX_custom_fields', $fields);
    }
